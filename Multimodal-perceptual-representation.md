...
```
┌───────────────────────────────────────────────────────────────────────────────┐
│                 Мультимодальная Перцептивная Репрезентация                    │
│                           в контексте теории ЭИРО                             │
└───────────────────────────────────────────────────────────────────────────────┘

┌───────────────────────┐  ┌────────────────────────┐  ┌────────────────────────┐
│ Сенсорная Интеграция  │  │ Темпоральная Интеграция│  │ Эмоциональная Модуляция│
│ - Конвергенция        │  │ - Связывание Событий   │  │ - Лимбическая Система  │
│ - Топография          │  │ - Ритмические Процессы │  │ - Нейромедиаторы       │
│ - Мультисенсорные     │  │                        │  │                        │
│   Нейроны             │  │                        │  │                        │
└───────────────────────┘  └────────────────────────┘  └────────────────────────┘

┌───────────────────────┐  ┌────────────────────────┐  ┌────────────────────────┐
│ Контекстуальная       │  │ Метакогнитивная        │  │ Социальная             │
│ Интеграция            │  │ Осведомленность        │  │ Интерактивность        │
│ - Окружающая Среда    │  │ - Осознание Ментальных │  │ - Социальный Контекст  │
│ - Социальный Контекст │  │   Процессов            │  │ - Теория Разума        │
│                       │  │ - Префронтальная Кора  │  │                        │
└───────────────────────┘  └────────────────────────┘  └────────────────────────┘
```
...
- θ - параметры внутренних моделей, интегрирующих информацию из разных модальностей
