...
```mermaid
graph TD
    A[Эмерджентность сознания] --> B[Определение эмерджентности]
    B --> C[Появление новых свойств]
    B --> D[Непредсказуемость свойств]
    
    A --> E[Сознание как эмерджентное свойство]
    E --> F[Не результат отдельных нейронов]
    E --> G[Возникает из взаимодействия нейронных сетей]
    E --> H[Субъективный опыт]
    
    A --> I[Примеры эмерджентности в нейронных сетях]
    I --> J[Синхронизация нейронных осцилляций]
    J --> K[Гамма-ритмы]
    I --> L[Обработка образов и концепций]
    L --> M[Высокоуровневые представления]
    
    A --> N[Теория ЭИРО]
    N --> O[Сложные рекуррентные взаимодействия]
    N --> P[Интеграция информации]
```
...
```mermaid
graph TD
    A[Интеграция информации] --> B[Необходимость интеграции]
    B --> C[Создание целостного восприятия]
    B --> D[Связывание разнородной информации]
    
    A --> E[Механизмы интеграции]
    E --> F[Функциональные связи]
    E --> G[Глобальная рабочая площадка]
    E --> H[Метрика интегрированной информации]
    
    F --> I[Нейронные пути]
    I --> J[Зрительная кора]
    I --> K[Слуховая кора]
    I --> L[Соматосенсорная кора]
    
    G --> M[Сознание как доступ к информации]
    M --> N[Широкораспространенная сеть]
    
    H --> O[Показатель интегрированной информации]
    O --> P[Φ]
    O --> Q[Φₑ]
    
    Q --> R[Количество интегрированной информации]
    Q --> S[Качество интегрированной информации]
    
    S --> T[Рекуррентная обработка]
    T --> U[Ψ интеграция]
    T --> V[λᵢⱼ рекуррентность]
```
...
```mermaid
graph TD
    A[Рекуррентные связи в мозге] --> B[Роль в сознательном опыте]
    B --> C[Теория Эмергентной Интеграции и Рекуррентного Отображения]
    C --> D[Эмерджентная интеграция информации]
    D --> E[Рекуррентные нейронные взаимодействия]

    A --> F[Рекуррентные контуры в мозге]
    F --> G[Таламо-кортикальные петли]
    G --> H[Генерация осцилляторных паттернов]
    F --> I[Кортико-кортикальные связи]
    I --> J[Рекуррентная интеграция информации]
    F --> K[Гиппокампально-неокортикальные взаимодействия]
    K --> L[Объединение воспоминаний и знаний]

    A --> M[Механизмы рекуррентной активации]
    M --> N[Реактивация памятных следов]
    M --> O[Генерация внутренних предсказаний]
    M --> P[Интеграция разрозненной информации]
    M --> Q[Поддержание активности нейронных ансамблей]

    A --> R[Нарушения рекуррентности]
    R --> S[Снижение рекуррентности]
    S --> T[Фрагментарные сознательные переживания]
    R --> U[Избыточная рекуррентность]
    U --> V[Сверхинтегрированные состояния]
    R --> W[Нарушение синхронизации]
    W --> X[Прерывистые сознательные переживания]
```
...
```mermaid
graph TD
    A[Предиктивное Кодирование] --> B[Основные Принципы]
    B --> C[Предиктивность Мозга]
    B --> D[Ошибка Предсказания]
    B --> E[Обновление Моделей]
    
    A --> F[Иерархическая Структура Мозга]
    F --> G[Многоуровневая Организация]
    F --> H[Нисходящие Потоки]
    F --> I[Восходящие Потоки]
    F --> J[Рекуррентность]

    A --> K[Принцип Свободной Энергии]
    K --> L[Свободная Энергия]
    K --> M[Минимизация Свободной Энергии]
    K --> N[Связь с Энергией]

    A --> O[Нейронные Реализации]
    O --> P[Предикторные Нейроны]
    O --> Q[Нейроны Ошибки]
    O --> R[Синаптическая Пластичность]
    O --> S[Коммуникация Между Уровнями]
    S --> T[Восходящие Связи]
    S --> U[Нисходящие Связи]
```
...
```mermaid
graph TD
    A[Роль внимания и рабочей памяти в интеграции информации] --> B[Внимание]
    A --> C[Рабочая память]
    
    B --> D[Механизмы отбора]
    B --> E[Модуляция активности]
    B --> F[Роль нейромодуляторов]
    
    D --> G[Селекция релевантной информации]
    E --> H[Усиление сигналов нейронных сетей]
    F --> I[Регуляция внимания нейромодуляторами]
    
    C --> J[Кратковременное удержание информации]
    C --> K[Интеракция с рекуррентными сетями]
    C --> L[Роль в интеграции информации]
    
    J --> M[Сохранение информации для обработки]
    K --> N[Связи между префронтальной корой и гиппокампом]
    L --> O[Удержание и манипулирование релевантной информацией]
    
    B --> P[Координация процессов интеграции]
    C --> P
```
...
```mermaid
graph TD
    A[Канонические микросхемы коры] --> B[Пирамидальные нейроны]
    A --> C[Горизонтальные связи]
    A --> D[Вертикальная интеграция]
    B --> E[Обширные дендритные деревья]
    C --> F[Временная синхронизация]
    C --> G[Объединение сенсорных признаков]
    D --> H[Иерархическая интеграция]
    D --> I[Взаимосвязанность нейронов]
    J[Долгосрочные и краткосрочные связи] --> K[Долгосрочные ассоциативные связи]
    J --> L[Краткосрочные локальные связи]
    K --> M[Связь зрительной и слуховой коры]
    K --> N[Формирование мультисенсорных репрезентаций]
    L --> O[Обмен информацией]
    L --> P[Объединение элементарных признаков]
    Q[Функциональная коннективность] --> R[Повышенная связность областей мозга]
    R --> S[Гармонизация сознательного опыта]
...
```mermaid
graph TD
    A[Таламо-кортикальные петли] --> B[Роль таламуса]
    A --> C[Таламо-кортикальные взаимодействия]
    A --> D[Генерация осцилляторных паттернов]
    A --> E[Роль в сознательном восприятии]

    B --> F[Центральный ретранслятор сенсорной информации]
    F --> G[Входные сигналы от сенсорных систем]
    F --> H[Передача в первичные сенсорные области коры]

    C --> I[Замкнутые рекуррентные петли]
    C --> J[Информация циркулирует между структурами]
    J --> K[Обратные проекции от коры к таламусу]

    D --> L[Ключевой источник генерации осцилляторных паттернов]
    L --> M[Характерные для различных фаз сна]
    L --> N[Синхронизация нейронной активности]

    E --> O[Циклическая обработка сенсорной информации]
    O --> P[Формирование сознательного восприятия]
    O --> Q[Нарушения приводят к расстройствам сознания]
```
...
```mermaid
graph TD
    A[Кортикокортикальные обратные связи] --> B[Обратные проекции между областями коры]
    B --> C[Нисходящие проекции]
    C --> D[Модуляция активности нижележащих областей]
    
    A --> E[Роль в предиктивном кодировании]
    E --> F[Формирование предсказаний]
    F --> G[Сравнение с сенсорными сигналами]

    A --> H[Интеграция сенсорной и контекстуальной информации]
    H --> I[Интеграция текущих сенсорных данных]
    I --> J[Формирование целостных перцептуальных репрезентаций]

    A --> K[Роль в сознательном восприятии]
    K --> L[Нарушения в работе обратных связей]
    L --> M[Дефициты в сознательном восприятии]
    M --> N[Ослабление рекуррентных взаимодействий]
```
...
```mermaid
graph TD
    A[Предсказательное кодирование] --> B[Иерархическая организация]
    A --> C[Ошибки предсказания]
    
    B --> D[Верхние области коры]
    B --> E[Нижние сенсорные области]
    
    D --> F[Префронтальная кора]
    D --> G[Ассоциативные зоны]
    D --> H[Формирование предсказаний]
    
    E --> I[Первичные сенсорные регионы]
    I --> J[Зрительная кора V1]
    I --> K[Сравнение сигналов]
    
    H --> L[Внутренние модели]
    L --> M[Предыдущий опыт]
    
    K --> N[Ошибка предсказания]
    N --> O[Восходящие связи]
    
    C --> P[Роль ошибок предсказания]
    P --> Q[Коррекция внутренних моделей]
    P --> R[Адаптация и обучение]
    
    O --> S[Обновление внутренних моделей]
    S --> T[Минимизация ошибок]
    
    R --> U[Адаптивное восприятие]
```
...
```mermaid
graph TD
    A[Нейромедиаторные системы] --> B[Моноаминергические системы]
    A --> C[Холинергическая система]
    
    B --> D[Серотонин 5-HT]
    B --> E[Норадреналин НА]
    B --> F[Дофамин ДА]
    
    D --> G[Депрессия и тревожность]
    D --> H[Рекуррентные взаимодействия]
    
    E --> I[Стресс и бодрствование]
    E --> J[Эмоциональная информация]
    
    F --> K[Вознаграждение и удовольствие]
    F --> L[Эмоциональная окраска]
    
    C --> M[Ацетилхолин АХ]
    
    M --> N[Рекуррентные взаимодействия]
    M --> O[Внимание и память]
    
    N --> P[Префронтальная кора]
    N --> Q[Гиппокамп]
    N --> R[Миндалина]
    
    P --> S[Эмерджентная интеграция Φₑ]
    Q --> T[Интеграция информации]
    R --> U[Эмоциональная информация]
    
    V[Дисбаланс нейромедиаторов] --> W[Нарушения рекуррентной активности]
    V --> X[Снижение Φₑ]
    V --> Y[Дисбаланс R t и E t]
...
```mermaid
graph TD
    A[Структурная и функциональная коннективность] --> B[Анализ связности]
    B --> C[Методы исследования]
    C --> D[Диффузионная тензорная визуализация]
    C --> E[Функциональная магнитно-резонансная томография]
    B --> F[Параметры анализа]
    F --> G[Плотность анатомических связей]
    F --> H[Временная корреляция активности]
    A --> I[Роль длинных ассоциативных путей]
    I --> J[Конвергенция сигналов]
    I --> K[Рекуррентные взаимодействия]
    I --> L[Синхронизация нейронных ансамблей]
    A --> M[Нарушения коннективности]
    M --> N[Дефициты интеграции информации]
    M --> O[Фрагментация сознательного опыта]
```
...
```mermaid
graph TD
    A[Нейровизуализационные исследования] --> B[фМРТ и ПЭТ-сканирование]
    B --> C[Иерархическая организация и интеграция информации]
    C --> D[Первичные сенсорные области]
    C --> E[Вторичные и ассоциативные области]
    B --> F[Рекуррентные взаимодействия и сознательное восприятие]
    F --> G[Фронто-париетальная сеть]
    F --> H[Дефолт-система мозга]
    B --> I[Нарушения интеграции при расстройствах сознания]
    I --> J[Кома]
    I --> K[Вегетативное состояние]

    A --> L[ЭЭГ и МЭГ]
    L --> M[Синхронизация нейронной активности]
    M --> N[Гамма-диапазон]
    L --> O[Рекуррентные взаимодействия и предиктивное кодирование]
    O --> P[Воспроизведение информации из памяти]
    L --> Q[Нарушения синхронизации при расстройствах сознания]
    Q --> R[Кома]
    Q --> S[Вегетативное состояние]
```
