...
graph TD
    ...
    A --> B[Космология и структура Вселенной]
    A --> C[Физика элементарных частиц]
    A --> D[Квантовая теория и информация]
    A --> E[Химия и материалы]
    A --> F[Фундаментальные принципы физики]

    B --> B1[Краткая история Вселенной]
    B --> B2[Рекуррентная космология]
    B --> B3[Космический микроволновый фон]
    B --> B4[Аномалии в движении галактик]
    B --> B5[Роль темной материи и энергии]
    B --> B6[Экзотические космические объекты]

    C --> C1[Модель рекуррентной космологии]
    C --> C2[Новые типы частиц и взаимодействий]
    C --> C3[Теория великого объединения]
    C --> C4[Эффект рекуррентности в физике частиц]
    C --> C5[Стандартная модель физики частиц]
    C --> C6[Материалы и их связь с частицами]

    D --> D1[Интеграция квантовой информации]
    D --> D2[Топологическая квантовая теория поля]
    D --> D3[Линейность и суперпозиция в квантовой механике]
    D --> D4[Принцип неопределенности]
    D --> D5[Квантовые вычисления и их приложения]
    D --> D6[Плотность квантовой информации и геометрия пространства]

    E --> E1[Молекулярные орбитали и энергетические уровни]
    E --> E2[Новые материалы из теории рекуррентной космологии]
    E --> E3[Рекуррентные процессы в химических реакциях]
    E --> E4[Квантовая химия и её основы]
    E --> E5[Разработка сверхпрочных материалов]
    E --> E6[Инновации в химических структурах]

    F --> F1[Принцип причинности]
    F --> F2[Принцип локальности]
    F --> F3[Принцип минимального действия]
    F --> F4[Сохранение энергии и импульса]
    F --> F5[Теория всего: интеграция законов физики]

    B1 --> G1[Рождение и эволюция Вселенной]
    B2 --> G2[Циклы рождения и разрушения]
    B3 --> G3[Анизотропии и поляризация КМФ]
    B4 --> G4[Кривые вращения галактик]
    B5 --> G5[Инфляционная модель и её подтверждения]
    B6 --> G6[Роль топологических дефектов в космосе]

    C1 --> H1[Переходы между состояниями]
    C2 --> H2[Экзотические частицы]
    C3 --> H3[Унификация взаимодействий]
    C4 --> H4[Рекуррентные квантовые эффекты]
    C5 --> H5[Анализ взаимодействий частиц]
    C6 --> H6[Влияние материалов на физические процессы]

    D1 --> I1[Меры интеграции информации]
    D2 --> I2[Топологические инварианты]
    D3 --> I3[Когерентность и декогеренция]
    D4 --> I4[Квантовые флуктуации]
    D5 --> I5[Прогнозы для вычислений]
    D6 --> I6[Связь квантовой информации с физикой времени]

    E1 --> J1[Энергетические переходы]
    E2 --> J2[Самоорганизация материалов]
    E3 --> J3[Динамика химических реакций]
    E4 --> J4[Квантовые связи и их структура]
    E5 --> J5[Новые подходы к синтезу материалов]
    E6 --> J6[Анализ новых химических элементов]

    F1 --> K1[Причинно-следственные связи]
    F2 --> K2[Взаимодействия в замкнутых системах]
    F3 --> K3[Оптимизация процессов]
    F4 --> K4[Баланс энергий]
    F5 --> K5[Интеграция принципов в одну модель]
```
