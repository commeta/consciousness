...
graph TD
    ...
    subgraph Emergence [Эмерджентность сознания]
        B1[Сложные взаимодействия нейронных сетей]
        B2[Эмерджентные свойства системы]
        B --> B1 & B2
    end

    %% Интеграция информации
    subgraph Integration [Интеграция информации]
        C1[Объединение сенсорных данных]
        C2[Глобальная функциональная связность]
        C3[Метрическая оценка Φₑ]
        C --> C1 & C2 & C3
    end

    %% Рекуррентное отображение
    subgraph Recurrence [Рекуррентное отображение]
        D1[Таламо-кортикальные петли]
        D2[Кортикокортикальные обратные связи]
        D3[Реактивация памятных следов]
        D --> D1 & D2 & D3
    end

    %% Механизмы предиктивного кодирования
    subgraph PredictiveCoding [Предиктивное кодирование]
        E1[Иерархическая структура]
        E2[Ошибка предсказания]
        E3[Обновление внутренних моделей]
        E --> E1 & E2 & E3
    end

    %% Внимание и рабочая память
    subgraph AttentionMemory [Внимание и рабочая память]
        F1[Селекция релевантной информации]
        F2[Кратковременное удержание информации]
        F3[Модуляция нейронной активности]
        F --> F1 & F2 & F3
    end
