...
- [Расширение теории ЭИРО с учетом дополнительных параметров метрики Φₑ](/extended-fe-metric.md)
  ...
  - [Социальный контекст S(t) в системе ЭИРО](/Social-context.md)

  - [Адаптивность A(t) как ключевой параметр эмерджентной интегрированной рекуррентной обработки](/Adaptability.md)
