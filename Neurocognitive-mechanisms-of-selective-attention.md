...
**Долговременное поддержание внимания**
...
**Координация распределенных процессов**
...
Усиление активности в релевантных областях:
...
Модуляция связности между регионами:
...
**Синхронизация нейронных ансамблей**
...
**Изменения вызванных потенциалов**
...
Одним из подходов является представление системы внимания как нелинейной динамической системы с множественными аттракторами. В этом случае состояния, соответствующие фокусировке на различных объектах или признаках, рассматриваются как устойчивые аттракторные состояния системы. Переключение внимания между ними происходит в результате флуктуаций или внешних воздействий, которые выводят систему из одного аттрактора и захватывают ее в другой. Математически это может быть описано с помощью систем дифференциальных уравнений, моделирующих конкурентную динамику нейронных ансамблей [1, 2].

**6.1.2 Стохастические процессы**

Альтернативный подход заключается в описании процессов внимания как стохастических процессов, где выбор фокуса внимания представляется как вероятностный выбор из множества альтернатив. Например, модели на основе марковских цепей могут описывать переключение внимания между различными объектами или задачами [3, 4]. Параметры таких моделей, такие как вероятности переходов, могут быть связаны с нейрофизиологическими механизмами.

**6.1.3 Осцилляторные модели**

Важную роль в процессах внимания играют ритмические нейронные процессы, в частности, синхронизация в гамма-диапазоне. Осцилляторные модели описывают динамику таких ритмических процессов и их влияние на селекцию информации. Например, модели на основе связанных осцилляторов могут объяснять, как синхронизация нейронных ансамблей обеспечивает интеграцию распределенных признаков объектов [5, 6].

Общим для этих подходов является представление процессов внимания как нелинейной, динамической системы, демонстрирующей богатое поведение, включая устойчивые состояния, переключения, колебания. Параметры таких моделей могут быть связаны с нейрофизиологическими механизмами, что позволяет интегрировать экспериментальные данные и теоретические представления.
...
где Pout_target - мощность выходного сигнала, связанного с целевыми стимулами, а Pout_distractors - мощность сигналов, соответствующих отвлекающим факторам.
...
Стабильность внимания Satt можно определить как:
...
Скорость переключения Sswitch можно определить как:

`Sswitch = 1 / τ,`

где τ - время релаксации нейронной активности при переключении внимания. Более высокие значения Sswitch соответствуют более быстрому переключению.
