...
```mermaid
graph TD
    A[Статистическая интерпретация термодинамики] --> B[Теоретическая основа]
    B --> C[Термодинамика и статистическая механика]
    B --> D[Теория информации и энтропия Шеннона]
    B --> E[Связь энтропии и информации]
    A --> F[Теория Эмергентной Интеграции и Рекуррентного Отображения]
    F --> G[Понятие эмерджентной информации]
    F --> H[Рекуррентные процессы в системах]
    A --> I[Введение информационных параметров в термодинамику]
    I --> J[Плотность интегрированной информации]
    I --> K[Параметр рекуррентности]
    I --> L[Энтропия и информация]
    A --> M[Влияние на фундаментальные принципы термодинамики]
    M --> N[Первое начало термодинамики]
    M --> O[Второе начало термодинамики]
    M --> P[Флуктуации и рекуррентность]
    A --> Q[Статистическая механика через призму ЭИРО]
    Q --> R[Распределение вероятностей]
    Q --> S[Модифицированная статистическая сумма]
    Q --> T[Следствия для физических систем]
    A --> U[Применение к космологии и модели вселенной]
    U --> V[Термодинамика вселенной]
    U --> W[Тёмная энергия и информация]
    U --> X[Модифицированные уравнения Эйнштейна]
    A --> Y[Доказательства и экспериментальные подтверждения]
    Y --> Z[Экспериментальные исследования]
    Y --> AA[Космологические наблюдения]
    Y --> AB[Термодинамика черных дыр]
```
