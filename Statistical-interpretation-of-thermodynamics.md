...
graph TD
    ...
    A --> B[Основы термодинамики]
    A --> C[Теория информации]
    A --> D[Введение информационных параметров]
    A --> E[Применение ЭИРО в термодинамике]
    A --> F[Применение к космологии]

    B --> B1[Энтропия в статистической механике]
    B --> B2[Связь макро- и микросостояний]

    C --> C1[Энтропия Шеннона]
    C --> C2[Связь информации и энтропии]
    C --> C3[Переосмысление энтропии через информацию]

    D --> D1[Плотность интегрированной информации ρ_IQI]
    D --> D2[Параметр рекуррентности R]
    D --> D3[Модифицированная формула энтропии]

    E --> E1[Первое начало термодинамики]
    E --> E2[Второе начало термодинамики]
    E --> E3[Флуктуации и рекуррентность]

    F --> F1[Термодинамика вселенной]
    F --> F2[Тёмная энергия и информация]
    F --> F3[Модифицированные уравнения Эйнштейна]
```
