...
• Интеграция и дифференциация: Сознание возникает в системах, которые одновременно являются высоко интегрированными (единое целое) и высоко дифференцированными (богатое разнообразие состояний).
