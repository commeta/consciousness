...
```mermaid
graph TD
    A[Сознание] --> B[Эмергентное свойство]
    B --> C[Интеграция информации]
    B --> D[Рекуррентная обработка]
    C --> E[Сложные паттерны нейронной активности]
    E --> F[Целостные репрезентации]
    D --> G[Рекуррентные нейронные сети]
    G --> H[Усиление интеграции]
    H --> I[Сознательные переживания]
    J[Нейробиология] --> K[Изучение нейронных сетей]
    J --> L[Синаптическая пластичность]
    J --> M[Нейромодуляция]
    K --> N[Моделирование процессов сознания]
    L --> N
    M --> N
    N --> O[Эмпирическая основа для теории ЭИРО]
```
...
```mermaid
graph TD
    A[Нейробиологические основы ЭИРО] --> B[Интеграция информации]
    A --> C[Рекуррентные нейронные сети]
    A --> D[Эмергенция сознания]

    B --> E[Сложные нейронные сети]
    B --> F[Объединение сенсорных и когнитивных сигналов]
    E --> G[Конвергенция сигналов]
    G --> H[Комплексные ответы нейронов]

    C --> I[Обратные связи между нейронами]
    C --> J[Непрерывная переработка информации]
    I --> K[Поддержание состояния активности]
    J --> L[Устойчивые паттерны активности]
    L --> M[Память и сознание]

    D --> N[Взаимодействие компонентов системы]
    D --> O[Сложная нейронная динамика]
    O --> P[Синхронизация нейронной активности]
    P --> Q[Координация областей мозга]
    Q --> R[Сознательные переживания]
```
...
```mermaid
graph TD
    A[Поддерживающие доказательства] --> B[Нейровизуализационные исследования]
    A --> C[Электрофизиологические данные]
    A --> D[Патологии и расстройства сознания]

    B --> E[Методы: фМРТ и электрофизиология]
    B --> F[Усиленная связность мозга]
    B --> G[Рекуррентная активность]
    F --> H[Интеграция информации]

    C --> I[Поздние возникающие потенциалы]
    C --> J[Прерывание рекуррентных сигналов]
    I --> K[Сознательное восприятие]
    J --> L[Нарушение осознания стимулов]
    K --> M[Глобальная neuronal workspace]

    D --> N[Расстройства сознания]
    D --> O[Нарушение рекуррентных связей]
    O --> P[Снижение функциональной коннективности]
    P --> Q[Снижение уровней сознания]
```
