...
1. Формулировка нового уравнения состояния
...
• Нелинейные модели: В случае более сложных систем может потребоваться использовать нелинейные функции, такие как:
...
1. Модифицированное уравнение Шрёдингера
...
2. Формулировка рекуррентного гамильтониана  ^H_(rec) 
...
3. Решение модифицированных уравнений
...
5. Влияние на классический предел
