...
graph TD
    ...
    A --> B[Интеграция ЭИРО в космологию]
    A --> C[Фазы цикла Вселенной]
    B --> D[Эмерджентные свойства космоса]
    B --> E[Рекуррентные процессы в масштабах Вселенной]
    C --> F[Рождение Вселенной Big BANG\BOUNCE]
    C --> G[Расширение и эволюция]
    C --> H[Сжатие и перезапуск цикла]
    D --> I[Формирование структуры материи]
    D --> J[Интеграция информации в процессах эволюции]
    E --> K[Квантовые флуктуации]
    E --> L[Гравитационная рекуррентность]
    F --> M[Инфляционная фаза]
    F --> N[Появление элементарных частиц]
    G --> O[Формирование галактик и звезд]
    G --> P[Роль темной энергии]
    H --> Q[Сжатие материи]
    H --> R[Квантовая сингулярность]
    A --> S[Приложения теории]
    S --> T[Прогнозы для космологических наблюдений]
    S --> U[Моделирование рекуррентных процессов]
    S --> V[Связь с крупномасштабной структурой]
```
