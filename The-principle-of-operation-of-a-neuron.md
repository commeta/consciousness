...
```mermaid
graph TD;
    A[Структурно-функциональная организация нейрона] --> B[Морфология нейрона]
    A --> C[Биоэлектрические свойства]
    A --> D[Синаптическая передача]
    A --> E[Нейромедиаторные системы]

    subgraph B1[Морфология]
        B --> B2[Дендриты]
        B --> B3[Сома]
        B --> B4[Аксон]
        B --> B5[Синаптические терминалы]
    end

    subgraph C1[Биоэлектрические свойства]
        C --> C2[Пространственно-временная суммация]
        C --> C3[Генерация потенциала действия]
        C --> C4[Модуляция возбудимости]
    end

    subgraph D1[Синаптическая передача]
        D --> D2[Химическая трансмиссия]
        D --> D3[Синаптическая пластичность]
        D --> D4[Метапластичность]
    end

    subgraph E1[Нейромедиаторные системы]
        E --> E2[Влияние на синаптическую передачу]
        E --> E3[Модуляция возбудимости]
        E --> E4[Гомеостатическая пластичность]
    end
```
