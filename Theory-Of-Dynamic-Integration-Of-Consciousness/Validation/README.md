...
Для всех планов верификации (Φₑ, классические метрики ТДИС, ДГА) качество исходного ЭЭГ-сигнала критично. Ниже — разбивка этапов предобработки с примерами и рекомендациями.
