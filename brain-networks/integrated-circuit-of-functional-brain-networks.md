# Интеграция атласов и аттракторная динамика в функциональных сетях мозга
...
- **Поддержание содержания во времени.** ИИТ предсказывала устойчивую активность в задней коре на протяжении всего стимула, а ГНКТ – кратковременное «воспламенение» в ПФК в начале и в конце стимула. Эксперимент показал, что лишь малая доля задних нейронов демонстрирует продолжительную, «sustained» активацию, отслеживающую длительность стимулов (≈25 из 657 электродов) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20PFC%20ROIs%2C%2099%20and,An%20exploratory%20decoding) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20posterior%20cortex%20ROIs%2C%2025,selective%20electrodes%20showed). Напротив, в ПФК **не найдено ожидаемого «двухфазного» ответа** (onset–offset): ни один из 655 префронтальных электродов не продемонстрировал профиля, требуемого ГНКТ [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20PFC%20ROIs%2C%2099%20and,An%20exploratory%20decoding). В перекрёстно–временном RSA задняя кора сохраняла категориальную информацию длительно, а в ПФК кодирование носило лишь кратковременный характер (только всплеск в начале) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20posterior%20cortex%20ROIs%2C%20cross,for%20results%20of%20all%20contrasts). Эти данные явно указывают на **отсутствие устойчивого глобального «воспламенения»** в ПФК и на ограниченную роль префронтальной активности в хранении сознательного содержимого.

- **Межрегиональная синхронизация.** ИИТ предполагала устойчивую гамма-синхронизацию между низкоуровневой (V1/V2) и высокоуровневой задней корой, а ГНКТ – кратковременные связи между ПФК и категорически-специфичными областями. iEEG-аналитика показала лишь **раннюю, кратковременную синхронизацию низких частот (2–25 Гц)** между категориальными зонами и V1/V2 (менее 0.75 с) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=yielded%20similar%20results,in%20the%20relevant%20time%20window), почти целиком обусловленную вызванным откликом, без устойчивой гамма-активности. Это противоречит ИИТ. Одновременно **нет содержательно-специфичной синхронизации между зонами лица/объектов и ПФК** в гамма-диапазоне [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=yielded%20similar%20results,in%20the%20relevant%20time%20window), что опровергает предсказание ГНКТ о «фазовом» канале связи. При использовании DFC-метрики (амплитудная ковариация) обнаружена кратковременная гамма-связь объектов с V1/V2 и устойчивые связи ПФК с областями лиц/объектов (в предсказанное окно) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20iEEG%2C%20we%20observed%20significant,117) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=The%20exploratory%20DFC%20results%20in,compared%20with%20472%20in%20PFC). fMRI-анализ gPPI показал избирательную связь от FFA к V1/V2, правой IFG и IPS при предъявлении лиц [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=Using%20fMRI%2C%20we%20evaluated%20connectivity,in%20interareal%20connectivity%20between%20object), но не обнаружил увеличения связи для объектов с ПФК. В целом ни одна из классических метрик межареальной синхронизации ГНКТ/ИИТ (PPC-фаза, гамма-связь) не подтвердилась (см. «full null» выводы [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=These%20results%20align%20with%20some,challenges%20extend%20to%20other%20theories) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=yielded%20similar%20results,in%20the%20relevant%20time%20window)).

### Соответствие с концепциями модели

- **Глобальное рабочее пространство (ГРП).** В разделе «Модели глобального рабочего пространства» отмечается роль **глобального воспламенения** через фронто-париетальную обратную связь. Ferrante et al. (2025) подчёркивают, что **ожидаемых устойчивых репрезентаций в ПФК не найдено**: нет ответов на окончание стимула, а перекодировка ориентации вообще отсутствует в ПФК [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=divergent%20results%20for%20IIT%20and,For%20iEEG%2C%20Bayes) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20PFC%20ROIs%2C%2099%20and,An%20exploratory%20decoding). Эти наблюдения прямо бросают вызов центральным предположениям ГРП о «глобальном аттракторе». Так, цитата Nature: «общий дефицит воспламенения в момент окончания стимула и ограниченное представление некоторых аспектов сознания в ПФК» [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=These%20results%20align%20with%20some,challenges%20extend%20to%20other%20theories) демонстрирует несоответствие между простыми вариантами ГНКТ и эмпирией. Это значит, что глобальное рабочее пространство, формализованное через длительные фронтальные возмущения, нуждается в уточнении с учётом слабости префронтальной активности.

- **Интегрированная информация (Φ).** ИИТ ассоциирует сознание с максимальным Φ в задней коре (т. н. «горячая зона») [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=IIT%20and%20GNWT%20explain%20consciousness,GNWT%20instead). Новые данные подтверждают, что задняя кора действительно кодирует содержимое: здесь возможно устойчивое декодирование категорий и идентичности [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20posterior%20cortex%20ROIs%2C%20cross,for%20results%20of%20all%20contrasts) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=divergent%20results%20for%20IIT%20and,For%20iEEG%2C%20Bayes). Однако ключевой компонент ИИТ – **длительная комплексная синхронизация** между сенсорными уровнями (рис.  [1a] – V1↔вентральная кора) – не выявлен [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=These%20results%20align%20with%20some,challenges%20extend%20to%20other%20theories) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=yielded%20similar%20results,in%20the%20relevant%20time%20window). Фраза из статьи: «отсутствие устойчивой синхронизации в задней коре противоречит утверждению, что сетевая связность определяет сознание» [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=These%20results%20align%20with%20some,challenges%20extend%20to%20other%20theories). Иными словами, несмотря на присутствие информации в задней коре, интеграция этих областей (Φ) оказалась не столь явной, как предполагалось. Также эксперимент показал, что добавление префронтальных данных не улучшает декодирования, что согласуется с тем, что ПФК не повышает Φ содержания [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=Finally%2C%20we%20tested%20IIT%E2%80%99s%20prediction,not%20improve%E2%80%94and%20in%20some%20cases).

- **Аттракторная динамика и критическая самоорганизация.** Файл подчёркивает, что мозг функционирует как ансамбль аттракторов с метастабильными переходами и критическим режимом самоорганизации. Открытие Ferrante et al. демонстрирует **быстро меняющуюся, слабосвязанную динамику**: активность непродолжительна, связи возникают лишь на короткое время и в низких частотах. Это больше похоже на **метастабильные переключения** между активными состояниями, чем на установившийся глобальный аттрактор. Отсутствие долговременной «позиционной» синхронизации (высокая лемпель-зив сложность против отсутствия устойчивой γ-связи) указывает на то, что сознательные образы не удерживаются в мозге в статичном режиме. Тем не менее эти данные не противоречат идее критической работы мозга: информация передавалась быстро и эффективно, хотя и без долгой фиксации, возможно отражая критическую чувствительность к новому стимулу.

- **Функциональные сети (DMN, CEN, SN).** Эксперимент был сенсорным и не акцентировал внимание на сетях покоя/чувствительности. Предполагается, что при задаче DMN снижен, что согласуется с антифазностью DMN и ЦЕН. Результаты показывают включение ЦЕН (лобы и париетальные узлы) при кодировании содержимого, но ограниченное (см. точность ~60–70% в ПФК [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=Finally%2C%20we%20tested%20IIT%E2%80%99s%20prediction,not%20improve%E2%80%94and%20in%20some%20cases)). Сеть салиентности (SN) могла участвовать в обнаружении целей, однако отчетливо не рассматривалась. Важно заметить, что ни в одном анализе не упоминались и не измерялись таламические структуры.

- **Модуляция таламусом.** В «Таламус: синхронизация и глобальная координация» подчёркивается, что интрамедианные ядра влияют на аттракторы через холинергическую активацию. В Ferrante et al. прямая роль таламуса не изучалась – фокус был на кортикальных записах. Тем не менее отсутствие префронтальных проявлений может указывать на то, что любые таламо-кортикальные влияния либо недостаточны для генерации «воспламенения» в ПФК, либо действуют через другие механизмы (например, через сенсорные зоны). Этот вопрос остаётся открытым в контексте новых данных.

### Выводы и предложения по корректировке модели

- **Дополним раздел о ГРП:** следует указать, что «Ferrante et al. (2025) не обнаружили предсказанного глобального «воспламенения» в ПФК при сознательном восприятии: префронтальные нейроны кодируют лишь часть контента и только в узкое время, а окончание стимула не сопровождается сильным всплеском» [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20PFC%20ROIs%2C%2099%20and,An%20exploratory%20decoding) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=divergent%20results%20for%20IIT%20and,For%20iEEG%2C%20Bayes). Например: *«В статье Ferrante et al. (Nature 2025) отмечено отсутствие ожидаемой двухфазной ПФК-активности: сознательное содержание представлено в ЦПР (постерорной коре), тогда как в ПФК обнаружено лишь кратковременное, ограниченное кодирование, особенно без репрезентации ориентации»* [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=divergent%20results%20for%20IIT%20and,For%20iEEG%2C%20Bayes) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20PFC%20ROIs%2C%2099%20and,An%20exploratory%20decoding).

- **Дополним раздел об ИИТ:** стоит подчеркнуть, что несмотря на правильное выделение задней коры как носителя сознательного контента, **гипотеза о глобальной интеграции** (Φ) между сенсорными узлами не нашла поддержки: «не было устойчивой гамма-синхронизации между зонами задней коры, как того ожидала ИИТ» [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=These%20results%20align%20with%20some,challenges%20extend%20to%20other%20theories). Можно добавить: *«Ferrante et al. констатируют, что одновременная активность цепочки V1→вентральная кора была короткой и низкочастотной, а не устойчивой, что ставит под сомнение простое тождество содержания сознания с полной связностью этой сети (Φ)»* [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=yielded%20similar%20results,in%20the%20relevant%20time%20window) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=These%20results%20align%20with%20some,challenges%20extend%20to%20other%20theories).

- **Комментарий к аттракторной парадигме:** результаты показывают быстроформируемые, неслабо связанные состояния, что лучше укладывается в концепцию **мета-стабильных аттракторов** с гибкими переходами. Поэтому имеет смысл отметить: «современные эксперименты поддерживают представление о том, что сознание может реализовываться через кратковременные аттракторные конфигурации в зрительной коре, не требующие устойчивой глобальной синхронизации».

### Связь с современными данными

- «Ferrante et al. (2025) провели строгую сравнительную проверку ИИТ и ГНКТ. Они показали, что информация о категории и идентичности содержимого извлекается из задней коры и даже частично из ПФК [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=divergent%20results%20for%20IIT%20and,For%20iEEG%2C%20Bayes) [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=Finally%2C%20we%20tested%20IIT%E2%80%99s%20prediction,not%20improve%E2%80%94and%20in%20some%20cases), но информация о ориентации представлена лишь в задней коре [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=divergent%20results%20for%20IIT%20and,For%20iEEG%2C%20Bayes). Добавление префронтальных данных не улучшало декодирования [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=Finally%2C%20we%20tested%20IIT%E2%80%99s%20prediction,not%20improve%E2%80%94and%20in%20some%20cases). Таким образом, сознательное содержание кодируется преимущественно в височно-париетальных зонах, а не за счёт глобального распространения в передней коре».

- «Отмечено, что префронтальная «сеть рабочего пространства» не продемонстрировала ожидаемого воспламенения: ни одного стабильного ответа на окончание стимула не найдено [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=In%20PFC%20ROIs%2C%2099%20and,An%20exploratory%20decoding). Это говорит о том, что модель глобального аттрактора требует доработки».

- «С точки зрения ИИТ, хотя задняя кора играет ключевую роль, сама интеграция (Φ) оказалась менее очевидной: отсутствовала длительная связность между V1 и более высокими визуальными областями [nature.com](https://www.nature.com/articles/s41586-025-08888-1?code=ef7596c6-d2ea-4c79-a558-3c6312576e81#:~:text=yielded%20similar%20results,in%20the%20relevant%20time%20window), несмотря на присутствие контентных сигналов».
