# Описание Multiple-Demand Network (MD) 
...
* **Корреляция с производительностью:** более высокая активация MD-регионов связана с повышенной точностью и сниженным временем реакции ([ScienceDirect][7]).
