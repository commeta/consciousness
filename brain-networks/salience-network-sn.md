...
* **Resting-state fMRI:** устойчивая корреляция сигналов AI и dACC в состоянии покоя формирует «базовый» профиль активности SN ([Nature][6]).
...
## Обновлённая таблица подсетей Salience Network

| Подсеть                         | Анатомические регионы                                     | Атлас           | Структурный тракт                                                                | Функциональная роль                                           | Пересечения с сетями | Источник                                                                                                                                                                                                 |
| ------------------------------- | --------------------------------------------------------- | --------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------- | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Cortical Core SN**            | Anterior Insula (FOP4, FOP5), dACC (a24, p24pr)           | HCP-MMP         | Uncinate Fasciculus; Cingulum Bundle                                             | Обнаружение значимости; переключение между DMN и CEN/DMN/VAN  | CEN, DMN, VAN        | Seeley et al. 2007; Menon V. 2015 ([JNeurosci](https://www.jneurosci.org/content/27/9/2349), [Wikipedia](https://en.wikipedia.org/wiki/Salience_network))                                              |
| **Subcortical Core SN**         | Ventral Striatum; Amygdala; Mediodorsal Thalamus; VTA/SNc | HCP-MMP; CIT168 | Cortico-striato-thalamic loops; Anterior Thalamic Radiation; Uncinate Fasciculus | Мотивационная оценка; вознаграждение                          | Limbic               | Uddin LQ. 2014; Peters et al. 2016 ([Wikipedia](https://en.wikipedia.org/wiki/Salience_network), [Wikipedia](https://en.wikipedia.org/wiki/Frontoparietal_network))                                     |
| **Temporoparietal (Auxiliary)** | Right TPJ (area 7m); Superior Temporal Gyrus              | HCP-MMP         | Superior Longitudinal Fasciculus                                                 | Обнаружение социальных/внешних значимых стимулов              | VAN, DMN             | Uddin LQ. 2014; Hermans et al. 2013 ([Wikipedia](https://en.wikipedia.org/wiki/Salience_network), [Frontiers](https://www.frontiersin.org/journals/human-neuroscience/articles/10.3389/fnhum.2023.1133367/full)) |
| **Motor Salience (Auxiliary)**  | Midcingulate Cortex (24dd, 24dv); SMA/Pre-SMA             | HCP-MMP         | Cingulum Bundle; U-fibers; Corticospinal Tract                                   | Подготовка двигательного ответа на значимые стимулы           | Sensorimotor; CEN    | Seeley et al. 2007; Quanta Magazine 2013 ([PubMed](https://pubmed.ncbi.nlm.nih.gov/17329432/), [Quanta](https://www.quantamagazine.org/inside-the-brains-salience-network-the-will-to-press-on-20131205/))       |
| **VLPFC (Auxiliary)**           | Ventrolateral PFC (area 47r, 47s)                         | HCP-MMP         | Fronto-striatal pathways                                                         | Оценка значимости стимулов; интеграция когнитивной информации | CEN, VAN             | Gong et al. 2016; Gratton et al. 2018 ([Wikipedia](https://en.wikipedia.org/wiki/Frontoparietal_network), [Wikipedia](https://en.wikipedia.org/wiki/Frontoparietal_network))                             |
