...
| Parent Network | Имя подсети                                | Анатомические регионы                                                             | Atlas                          | Структурный тракт                                      | Функциональная роль                                                   | Пересечения с другими сетями                               |
|----------------|--------------------------------------------|-----------------------------------------------------------------------------------|--------------------------------|--------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------|
| TPN            | Dorsal Attention Network (DAN)             | Intraparietal Sulcus (IPS), Frontal Eye Fields (FEF), Superior Parietal Lobule     | Yeo et al. 7-network atlas     | Superior Longitudinal Fasciculus II/III               | Voluntary orienting of visuospatial attention; топ-down контроль внимания | Ventral Attention Network; Fronto-Parietal Control Network  |
| TPN            | Ventral Attention Network (VAN)            | Right Temporoparietal Junction (rTPJ), Middle Frontal Gyrus (MFG), Inferior Frontal Gyrus (IFG) | Yeo et al. 7-network atlas     | –                                                      | Стимул-ориентированное переключение внимания на внезапно появившиеся события | –                                                          |
| TPN            | Fronto-Parietal Control Network (FPCN)     | Dorsolateral Prefrontal Cortex (DLPFC), Inferior Parietal Lobule (IPL)             | Dosenbach et al. parcellation  | Superior Longitudinal Fasciculus (DLPFC↔PPC)           | Адаптивная когнитивная гибкость: переключение задач, рабочая память         | Dorsal Attention Network; Cingulo-Opercular Network       |
| TPN            | Cingulo-Opercular Network (CON)            | Anterior Cingulate Cortex (ACC), Anterior Insula/Operculum, Thalamus               | Dosenbach et al. parcellation  | Cingulum bundle; Frontal opercular tracts             | Поддержание задачи, мониторинг ошибок, стабильный контроль выполнения задач | Salience Network; Fronto-Parietal Control Network         |
| TPN            | Salience Network (SN)                      | Anterior Insula (AI), Dorsal ACC, Inferior Parietal Cortex, Ventral Striatum       | Yeo et al. 7-network atlas     | Uncinate fasciculus; Frontal aslant tract              | Обнаружение и интеграция значимых внутренних и внешних стимулов; переключение между сетями | Cingulo-Opercular Network; Ventral Attention Network      |
| TPN            | Fronto-Striatal Circuit                    | DLPFC, Caudate Nucleus, Putamen, Thalamus                                          | Frontostriatal connectivity atlas | Anterior limb of internal capsule; corticostriatal pathways | Когнитивный контроль, принятие решений, обучение на основе вознаграждения    | Fronto-Parietal Control Network; Reward Network           |
| TPN            | Thalamocortical Circuit                    | Mediodorsal Thalamus (MD), DLPFC, PPC                                              | Thalamocortical connectivity atlas | Thalamocortical radiations                           | Гейтинговая роль в поддержке представлений задач в разных функциональных доменах | Cingulo-Opercular Network; Fronto-Parietal Control Network |
| TPN            | Cerebello-Cortical Cognitive Network       | Neocerebellar Crus I/II, DLPFC, Inferior Parietal Lobule                            | Buckner et al. cerebellar atlas | Cortico-ponto-cerebellar; Cerebello-thalamo-cortical tracts | Координация когнитивных процессов, рабочая память, адаптивное поведение      | Fronto-Parietal Control Network; Fronto-Striatal Circuit |
| TPN            | Central Executive Network (CEN)            | Dorsolateral Prefrontal Cortex (DLPFC), Posterior Parietal Cortex (PPC)            | Yeo et al. 7-network atlas     | Superior Longitudinal Fasciculus                      | Управление вниманием, рабочая память, когнитивный контроль                 | Salience Network; Default Mode Network                    |
| TPN            | Sensorimotor Network (SMN)                 | Precentral Gyrus, Postcentral Gyrus, Supplementary Motor Area                      | Yeo et al. 7-network atlas     | Corticospinal tract                                   | Сенсомоторная интеграция, выполнение движений                              | –                                                          |
| TPN            | Visual Network (VIS)                       | Primary Visual Cortex (V1), Lateral and Superior Occipital Gyrus, Lingual Gyrus    | Yeo et al. 7-network atlas     | Optic radiations                                      | Обработка визуальной информации, восприятие                                 | Dorsal Attention Network                                  |
| TPN            | Auditory Network (AUD)                     | Heschl’s Gyrus, Superior Temporal Gyrus, Posterior Insular Cortex                  | Yeo et al. 7-network atlas     | Acoustic radiations                                   | Обработка слуховой информации                                            | –                                                          |
