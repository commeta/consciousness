# Описание Task-Positive Network (TPN)
...
### Таблица: Подсети Task-Positive Network (TPN)

| Имя подсети                                | Анатомические регионы                                                             | Атлас                          | Структурный тракт                                      | Функциональная роль                                                   | Пересечения с сетями | Источник |
|--------------------------------------------|-----------------------------------------------------------------------------------|--------------------------------|--------------------------------------------------------|------------------------------------------------------------------------|------------------------------|----------|
| Dorsal Attention Network (DAN)             | Intraparietal Sulcus (IPS), Frontal Eye Fields (FEF), Superior Parietal Lobule    | Yeo et al. 7-network atlas     | Superior Longitudinal Fasciculus II/III               | Произвольная ориентация зрительно-пространственного внимания; топ-down контроль внимания | VAN, FPCN | [Bedini & Baldauf, 2021](https://pubmed.ncbi.nlm.nih.gov/34273134/) |
| Ventral Attention Network (VAN)            | Right Temporoparietal Junction (rTPJ), Middle Frontal Gyrus (MFG), Inferior Frontal Gyrus (IFG) | Yeo et al. 7-network atlas     | –                                                      | Стимул-ориентированное переключение внимания на внезапно появившиеся события | – | [Bernard et al., 2020](https://pubmed.ncbi.nlm.nih.gov/32579719/) |
| Fronto-Parietal Control Network (FPCN)     | Dorsolateral Prefrontal Cortex (DLPFC), Inferior Parietal Lobule (IPL)            | Dosenbach et al. parcellation  | Superior Longitudinal Fasciculus (DLPFC↔PPC)           | Адаптивная когнитивная гибкость: переключение задач, рабочая память         | DAN, CON | [Marek & Dosenbach, 2018](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6136121/) |
| Cingulo-Opercular Network (CON)            | Anterior Cingulate Cortex (ACC), Anterior Insula/Operculum, Thalamus              | Dosenbach et al. parcellation  | Cingulum bundle; Frontal opercular tracts             | Поддержание задачи, мониторинг ошибок, стабильный контроль выполнения задач | SN, FPCN | [Sridharan et al., 2023](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10592749/) |
| Salience Network (SN)                      | Anterior Insula (AI), Dorsal ACC, Inferior Parietal Cortex, Ventral Striatum      | Yeo et al. 7-network atlas     | Uncinate fasciculus; Frontal aslant tract              | Обнаружение и интеграция значимых внутренних и внешних стимулов; переключение между сетями | CON, VAN | [Seeley, 2019](https://www.jneurosci.org/content/39/50/9878) |
| Fronto-Striatal Circuit                    | DLPFC, Caudate Nucleus, Putamen, Thalamus                                         | Frontostriatal connectivity atlas | Anterior limb of internal capsule; corticostriatal pathways | Когнитивный контроль, принятие решений, обучение на основе вознаграждения    | FPCN, Reward | [Choi et al., 2016](https://pubmed.ncbi.nlm.nih.gov/26673945/) |
| Thalamocortical Circuit                    | Mediodorsal Thalamus (MD), DLPFC, PPC                                             | Thalamocortical connectivity atlas | Thalamocortical radiations                           | Гейтинговая роль в поддержке представлений задач в разных функциональных доменах | CON, FPCN | [Chen et al., 2025](https://www.nature.com/articles/s41467-025-58011-1) |
| Cerebello-Cortical Cognitive Network       | Neocerebellar Crus I/II, DLPFC, Inferior Parietal Lobule                          | Buckner et al. cerebellar atlas | Cortico-ponto-cerebellar; Cerebello-thalamo-cortical tracts | Координация когнитивных процессов, рабочая память, адаптивное поведение      | FPCN, Fronto-Striatal | [Buckner et al., 2011](https://pubmed.ncbi.nlm.nih.gov/21795627/) |
| Central Executive Network (CEN)            | Dorsolateral Prefrontal Cortex (DLPFC), Posterior Parietal Cortex (PPC)           | Yeo et al. 7-network atlas     | Superior Longitudinal Fasciculus                      | Управление вниманием, рабочая память, когнитивный контроль                 | SN, DMN | [Bigliassi et al., 2025](https://pubmed.ncbi.nlm.nih.gov/39856810/) |
| Sensorimotor Network (SMN)                 | Precentral Gyrus, Postcentral Gyrus, Supplementary Motor Area                     | Yeo et al. 7-network atlas     | Corticospinal tract                                   | Сенсомоторная интеграция, выполнение движений                              | – | [Zhou et al., 2025](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12056360/) |
| Visual Network (VIS)                       | Primary Visual Cortex (V1), Lateral and Superior Occipital Gyrus, Lingual Gyrus   | Yeo et al. 7-network atlas     | Optic radiations                                      | Обработка визуальной информации, восприятие                                 | DAN | [Zhang et al., 2022](https://pubmed.ncbi.nlm.nih.gov/35407515/) |
| Auditory Network (AUD)                     | Heschl’s Gyrus, Superior Temporal Gyrus, Posterior Insular Cortex                 | Yeo et al. 7-network atlas     | Acoustic radiations                                   | Обработка слуховой информации                                            | – | [Kumar et al., 2023](https://journals.plos.org/plosbiology/article?id=10.1371%2Fjournal.pbio.3002239) |
