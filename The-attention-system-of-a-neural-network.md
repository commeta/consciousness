...
```mermaid
graph TD
    A[Механизмы внимания у человека] --> B[Нейрофизиологические основы]
    A --> C[Рекуррентная обработка и осознание]
    A --> D[Модели внимания]

    B --> B1[Префронтальная кора]
    B --> B2[Теменная доля]
    B --> B3[Таламус]

    B1 --> B1a[Функции: планирование, когнитивный контроль]
    B1 --> B1b[Роль: топ-даун модуляция внимания]
    B1 --> B1c[Механизмы: нисходящие связи]

    B2 --> B2a[Функции: пространственная ориентация]
    B2 --> B2b[Роль: перераспределение внимания]
    B2 --> B2c[Механизмы: интеграция информации]

    B3 --> B3a[Функции: фильтрация сенсорных сигналов]
    B3 --> B3b[Роль: регуляция восприятия]
    B3 --> B3c[Механизмы: усиление или подавление сигналов]

    C --> C1[Рекуррентная нейронная активность]
    C --> C2[Эксперименты с визуальной маскировкой]
    C --> C3[Значение для осознания]

    C1 --> C1a[Определение: обмен между областями мозга]
    C1 --> C1b[Роль: интеграция сенсорных данных]

    C2 --> C2a[Методика: предъявление стимула и маски]
    C2 --> C2b[Наблюдения: нарушение осознания]

    C3 --> C3a[Роль рекуррентности: осознание стимулов]
    C3 --> C3b[Интеграция с контекстом и опытом]

    D --> D1[Топ-даун внимание]
    D --> D2[Боттом-ап внимание]

    D1 --> D1a[Целенаправленное: основано на мотивациях]
    D1 --> D1b[Нейронные механизмы: ПК, нисходящие связи]
    D1 --> D1c[Примеры: поиск объекта]

    D2 --> D2a[Стимул-зависимое: реакция на яркие сигналы]
    D2 --> D2b[Нейронные механизмы: сенсорные области]
    D2 --> D2c[Примеры: громкий звук]

    D --> D3[Рекуррентные связи]
    D3 --> D3a[Интеграция топ-даун и боттом-ап сигналов]
