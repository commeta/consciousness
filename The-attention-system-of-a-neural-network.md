...
$$ \Phi_e = \int_0^{t_1} I_{\text{integration}}(t) \times R_{\text{recurrence}}(t) \, dt, $$
...
$$ A(t) = \sigma\left(\int_0^{t} I_{\text{integration}}(\tau) \times R_{\text{recurrence}}(\tau) \, d\tau\right), $$
...
$$ \mathcal{L} = \mathcal{L}_{\text{standard}} + \lambda \left(-\Phi_e\right), $$

где $\mathcal{L}_{\text{standard}}$ — стандартная функция потерь, $\lambda$ — коэффициент регуляризации.
