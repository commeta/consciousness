...
• Специфика измерений:
- Многополосная EPI-последовательность
- Коррекция движения в реальном времени
- Параллельная визуализация GRAPPA (R=3)
[Uğurbil et al., 2013, NeuroImage]

Преимущества метода:
- Визуализация отдельных кортикальных слоев
- Детекция активности в субмиллиметровых структурах
- Картирование рекуррентных связей между слоями коры
[Polimeni et al., 2018, Nature Neuroscience]

##### 2.1.2 МЭГ/ЭЭГ высокого разрешения:
• Характеристики:
- 256-канальная система
...
[Michel & Brunet, 2019, Nature Reviews Neuroscience]

##### 2.1.3 Оптогенетическая стимуляция:
• Технические параметры:
- Длина волны: 470/590 нм
- Мощность: 5-20 мВт/мм²
- Временное разрешение: <1 мс

Применяемые опсины:
- ChR2 для активации
- ArchT для ингибирования
- Step-function опсины для длительной модуляции
[Deisseroth, 2015, Nature Methods]
...
- Размерность: 10⁶ нейронов
- Временной шаг: 0.1 мс
- Учёт синаптической пластичности
[Markram et al., 2015, Cell]

Интеграция методов:
• Мультимодальный анализ:
- Совмещение фМРТ/МЭГ данных
- Валидация моделей через оптогенетику
- Байесовская оптимизация параметров

Ключевые преимущества комбинации методов:
1. Пространственно-временная точность
2. Причинно-следственный анализ
3. Проверка теоретических предсказаний
[Kringelbach & Deco, 2020, Nature Reviews Neuroscience]
