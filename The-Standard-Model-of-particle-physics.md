...
graph TD
    ...
    A --> D[Основные элементы стандартной модели]

    B --> E[Эмерджентность элементарных частиц]
    B --> F[Рекуррентные процессы в взаимодействиях]
    B --> G[Интеграция информации в частицах]

    C --> H[Влияние на крупномасштабную структуру]
    C --> I[Роль тёмной материи и энергии]
    C --> J[Космологические последствия модели]

    D --> K[Фундаментальные частицы]
    D --> L[Силы взаимодействия]
    D --> M[Математический аппарат модели]

    E --> N[Формирование частиц через квантовые флуктуации]
    F --> O[Рекуррентные взаимодействия в протонах и нейтронах]
    G --> P[Информационные свойства кварков]

    H --> Q[Связь с эволюцией галактик]
    I --> R[Распределение тёмной материи]
    J --> S[Прогнозы для космологических исследований]

    K --> T[Кварки и лептоны]
    L --> U[Электромагнитное взаимодействие]
    L --> V[Сильное взаимодействие]
    L --> W[Слабое взаимодействие]
    L --> X[Гравитация как интеграционный фактор]

    M --> Y[Уравнения Лагранжа для частиц]
    M --> Z[Теория групп и симметрия]

    P --> AA[Передача информации через взаимодействия]
    S --> AB[Моделирование структуры Вселенной]
    X --> AC[Интеграция гравитации в стандартную модель]
```
