...
3. Веса синаптических связей wᵢ модулируют вклад различных нейронных ансамблей в общую интегрированную информацию.

4. Суммирование по всем нейронным ансамблям (индекс i) и интегрирование по пространству (∫dx) дает интегральную меру эмергентной интегрированной информации Φₑ(t).
...
ГЛАВА 4. МЕХАНИЗМЫ ПАМЯТИ В КОНТЕКСТЕ ЭИРО
...
- K(s) - ядро консолидации, определяющее вклад эмергентной интегрированной информации Φₑ(t-s) в укрепление памятного следа в момент времени (t-s)
