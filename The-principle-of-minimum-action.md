...
```mermaid
graph TD
    A[Принцип минимального действия]
    A --> B[Рассмотрение через ЭИРО]
    A --> C[Связь с новой моделью Вселенной]
    A --> D[Основные аспекты принципа]

    B --> E[Эмерджентность в действии систем]
    B --> F[Рекуррентные процессы в применении принципа]
    B --> G[Интеграция минимизации действия]

    C --> H[Влияние квантовых флуктуаций]
    C --> I[Гравитация и минимизация энергии]
    C --> J[Космологические приложения принципа]

    D --> K[Физическое значение минимального действия]
    D --> L[Связь с уравнениями движения]
    D --> M[Принцип на макро- и микроуровнях]

    E --> N[Оптимизация энергетических затрат]
    F --> O[Рекуррентные решения уравнений]
    G --> P[Объединение с интеграцией информации]

    H --> Q[Минимизация в квантовых системах]
    I --> R[Сохранение энергии в масштабе Вселенной]
    J --> S[Прогнозирование эволюции структуры Вселенной]

    K --> T[Связь с законами сохранения]
    L --> U[Выводы из уравнений Лагранжа]
    M --> V[Применение в сложных системах]

    P --> W[Приложения принципа]
    W --> X[Уточнение космологических моделей]
    W --> Y[Предсказания для экспериментов]
    W --> Z[Моделирование физических процессов]
```
