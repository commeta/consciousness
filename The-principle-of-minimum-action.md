...
```mermaid
graph TD
    A[Принцип минимального действия] --> B[Основы теории ЭИРО]
    B --> C[Математический формализм]
    C --> D[Лагранжиан как функция интеграции информации]
    D --> E[Принцип оптимизации действий]
    B --> F[Эмергентная интеграция]
    F --> G[Роль рекуррентных процессов]
    G --> H[Информация как ключевая переменная]
    A --> I[Применение в космологии]
    I --> J[Оптимизация эволюции Вселенной]
    I --> K[Связь с интеграцией квантовой информации]
    I --> L[Объяснение крупномасштабной структуры]
    A --> M[Применение в квантовой механике]
    M --> N[Модификация уравнений движения]
    M --> O[Влияние рекуррентности на квантовые состояния]
    M --> P[Энергетические спектры и симметрии]
```
