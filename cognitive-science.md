...
```mermaid
graph TD
    A[Сознание] --> B[Когнитивная наука]
    B --> C[Психология]
    B --> D[Нейронаука]
    B --> E[Философия]
    B --> F[Искусственный интеллект]
    
    A --> G[Теория ЭИРО]
    G --> H[Эмергентная интеграция]
    G --> I[Рекуррентное отображение]
    
    H --> J["Интеграция информации (Iинтеграции(t))"]
    I --> K["Рекуррентная обработка (Rрекуррентности(t))"]
    J --> L["Эмергентная интегрированная информация (Φₑ)"]
    K --> L
    
    L --> M[Сознательные состояния]
    
    G --> N[Динамические системы]
    N --> O[Текущее состояние системы]
    N --> P[Непрерывное обновление знаний]
...
```mermaid
graph TD
    A[Когнитивные механизмы ЭИРО] --> B[Интеграция информации]
    A --> C[Рекуррентные процессы]
    A --> D[Предсказательное кодирование]
    
    B --> E[Мультисенсорная интеграция]
    E --> F[Единая перцептивная модель]
    B --> G[Влияние на внимание]
    G --> H["Пример: Driver и Noesselt (2008)"]
    
    C --> I[Обратная связь]
    C --> J[Топ-даун модуляция]
    J --> K[Контроль внимания]
    J --> L[Рабочая память]
    L --> M[Поддержка активной информации]
    C --> N["Пример: Miller и Cohen (2001)"]
    
    D --> O[Внутренние модели мира]
    D --> P[Предсказание сенсорных входов]
    D --> Q[Минимизация ошибок предсказания]
    Q --> R[Рекуррентные процессы]
    D --> S["Пример: Friston (2010)"]
```
...
```mermaid
graph TD
    A[Поддерживающие доказательства] --> B[Внимание и интеграция информации]
    A --> C[Рабочая память и рекуррентные процессы]
    A --> D[Сознательное восприятие и предсказание]
    
    B --> E[Выбор релевантной информации]
    B --> F[Усиление интеграции информации]
    F --> G[Рекуррентная обработка]
    F --> H["Пример: Cohen et al. (2012)"]
    
    C --> I[Поддержка информации]
    I --> J[Манипуляция информацией]
    I --> K[Сложные когнитивные операции]
    C --> L["Пример: Baddeley (2003)"]
    
    D --> M[Интеграция с ожиданиями]
    D --> N[Обновление внутренних моделей]
    N --> O[Несоответствие ожиданий и реальности]
    O --> P[Рекуррентная обработка]
    P --> Q[Сознательный опыт]
    D --> R["Пример: Hohwy (2012)"]
```
...
```mermaid
graph TD
    A[Обсуждение] --> B[ЭИРО и существующие когнитивные теории]
    A --> C[Применение в изучении сознания]
    
    B --> D[Интеграция информации]
    B --> E[Рекуррентные процессы]
    B --> F[Предсказательное кодирование]
    B --> G["Теория глобального рабочего пространства (Baars, 1988)"]
    B --> H[Сознание через интеграцию в глобальном пространстве]
    B --> I[Дополнение теории предсказательного кодирования]
    
    C --> J[Концептуальная рамка]
    J --> K[Интеграция когнитивных и нейронных процессов]
    C --> L[Понимание эмергентных свойств сознания]
    C --> M[Разработка моделей сознания]
    C --> N[Интерпретация эмпирических данных]
```
