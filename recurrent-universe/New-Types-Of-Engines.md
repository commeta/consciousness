...
```mermaid
flowchart TD
    A[Теория ЭИРО] --> B[Новая модель вселенной]
    B --> C[Квантовая информация и рекуррентные процессы]
    C --> D[Двигатели на основе квантовой информации]
    
    subgraph D_1[Основные принципы]
        E["Интегрированная квантовая информация (Φₑ)"]
        F[Рекуррентные квантовые процессы]
        G[Эмергентные свойства]
        E --> F
        F --> G
    end
    ...
    subgraph D_2[Механизм работы]
        H[Создание когерентного квантового состояния]
        I[Рекуррентная обработка и интеграция информации]
        J[Преобразование информации в энергию]
        K[Вывод энергии и совершение работы]
        H --> I
        I --> J
        J --> K
    end
    ...
    subgraph D_3[Ключевые научные вопросы]
        L[Квантовая информация как источник энергии]
        M[Роль рекуррентных процессов в эмергентных свойствах]
        N["Влияние ρ₍IQI₎ на метрику пространства-времени"]
        O[Физические параметры двигателя]
    end
    
    D --> D_3
    
    subgraph D_4[Перспективные исследования]
        P[Модели и симуляции]
        Q[Экспериментальное подтверждение]
        R[Материалы и технологии]
    end
...
flowchart TD
    A[Теория ЭИРО] --> B[Новая модель вселенной]
    B --> C[Рекуррентные процессы и информация]
    C --> D[Двигатели на основе рекуррентных процессов]
    
    subgraph D_1[Основные этапы работы]
        E[Инициация рекуррентного цикла]
        F[Эмергентное усиление процессов]
        G[Экстракция полезной работы]
        E --> F
        F --> G
    end
    ...
    subgraph D_2[Ключевые аспекты реализации]
        H[Динамическая устойчивость]
        I[Оптимизация параметра рекуррентности R]
        J[Минимизация потерь энергии]
        H --> I
        I --> J
    end
    ...
    subgraph D_3[Научные вопросы]
        K[Интеграция информации и физическая реализация]
        L[Рекуррентность как источник эмергентных свойств]
        M[Пересмотр фундаментальных законов]
    end
    
    D --> D_3
    
    subgraph D_4[Технологические вызовы]
        N[Контроль квантовых систем]
        O[Материалы с особыми свойствами]
        P[Новые методы измерения и детекции]
    end
    
    D --> D_4
    
    subgraph D_5[Перспективы]
        Q[Высокоэффективные энергетические системы]
        R[Углубление понимания процессов во вселенной]
        S[Мультидисциплинарные открытия]
    end
...
```mermaid
flowchart TD
    A[Основные научные вопросы и вызовы] --> B["Изменение ρ_(IQI) и R"]
    A --> C[Влияние на пространство-время]
    A --> D[Энергетическая эффективность и термодинамика]
    
    subgraph B_1["Изменение ρ_(IQI) и R"]
        E[Контроль квантовой информации]
        F[Технологические ограничения]
        E --> F
    end
    
    B --> B_1
    
    subgraph C_1[Влияние на пространство-время]
        G[Совместимость с общей теорией относительности]
        H[Наблюдаемые эффекты]
        G --> H
    end
    
    C --> C_1
    
    subgraph D_1[Энергетическая эффективность и термодинамика]
        I[Энергетический баланс]
        J[Термодинамические пределы]
        I --> J
    end
