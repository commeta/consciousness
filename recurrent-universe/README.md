...
graph TD
    ...
    A --> B[Основные принципы теории]
    A --> C[Рекуррентные процессы]
    A --> D[Приложения новой парадигмы]

    B --> E[Цикличность Вселенной]
    B --> F[Интеграция информации]
    B --> G[Эмерджентность]

    C --> H[Квантовые флуктуации]
    C --> I[Гравитационные волны]
    C --> J[Эволюция структуры Вселенной]

    D --> K[Космология]
    D --> L[Физика элементарных частиц]
    D --> M[Квантовые технологии]

    E --> N[Переход между циклами]
    E --> O[Инфляционные этапы]
    F --> P[Анализ информационных потоков]
    F --> Q[Роль топологических дефектов]
    G --> R[Формирование сложных систем]
    G --> S[Самоорганизация галактик]

    H --> T[Возникновение неоднородностей]
    H --> U[Анизотропии космического микроволнового фона]
    I --> V[Рекуррентные характеристики волн]
    I --> W[Связь с темной материей]
    J --> X[Формирование звёздных систем]
    J --> Y[Крупномасштабная структура]

    K --> Z[Предсказание параметров Вселенной]
    L --> AA[Обнаружение новых частиц]
    M --> AB[Применение в квантовых вычислениях]

    N --> AC[Перезапуск циклов]
    O --> AD[Равномерность распределения материи]
```
