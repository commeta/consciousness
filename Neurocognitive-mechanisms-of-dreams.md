...
graph TD
    ...
    B --> D["Стадия 1 (N1)"]
    D --> E[Снижение активности мозга]
    D --> F["Тета-ритмы (4-8 Гц)"]

    B --> G["Стадия 2 (N2)"]
    G --> H["Веретена сна (12-14 Гц)"]
    G --> I[К-комплексы]
    G --> J[Снижение активности мозга]

    B --> K["Стадии 3-4 (N3)"]
    K --> L["Дельта-волны (0.5-4 Гц)"]
    K --> M[Минимальная активность мозга]
    K --> N[Повышение активности таламуса, гипоталамуса, ствола мозга]

    C --> O[Активация мозга, схожая с бодрствованием]
    O --> P[Активация коры]
    O --> Q[Повышение кровотока и метаболизма]
    O --> R[Быстрые глазодвигательные движения]
    C --> S["Бета-ритмы (13-30 Гц)"]
    C --> T["Гамма-ритмы (30-100 Гц)"]
    C --> U[Активация холинергической системы]
    C --> V[Снижение моноаминергической активности]

    A --> W[Связь с теорией ЭИРО]
    W --> X[Снижение Φₑ и рекуррентности в NREM]
    W --> Y[Повышение Φₑ и рекуррентности в REM]
...
graph TD
    ...
    A --> C[Кортико-кортикальные связи]
    A --> D[Гиппокампально-неокортикальные взаимодействия]
    
    B --> E[Осцилляторные паттерны REM-сна]
    C --> F[Интеграция информации между ассоциативными областями]
    D --> G[Объединение воспоминаний и знаний]

    A --> H[Механизмы рекуррентной активации]
    H --> I[Реактивация памятных следов]
    I --> J[Повторная активация нейронных ансамблей]
    H --> K[Генерация внутренних предсказаний]
    K --> L[Проекция предсказаний в сновидения]
    H --> M[Интеграция разрозненной информации]
    M --> N[Объединение памяти, восприятия и фантазии]
    H --> O[Поддержание активности нейронных ансамблей]
    O --> P[Стабильность и непрерывность сновидений]

    A --> Q[Нарушения рекуррентности]
    Q --> R[Снижение рекуррентности]
    R --> S[Фрагментарные сновидения]
    Q --> T[Избыточная рекуррентность]
    T --> U[Причудливые сновидения]
...
graph TD
    ...
    B --> C["Ацетилхолин (АХ)"]
    C --> D[Повышение активности в REM-сне]
    D --> E[Активация коры]
    D --> F[Генерация сновидений]
    C --> G[Холинергические агонисты]
    G --> H[Индукция REM-сна и сновидений]

    A --> I[Моноаминергические системы]
    I --> J["Серотонин (5-HT)"]
    J --> K[Снижение уровня в REM-сне]
    K --> L[Ослабление сознательного контроля]
    J --> M[Снижение яркости сновидений при антидепрессантах]
    I --> N["Норадреналин (НА)"]
    N --> O[Снижение концентрации в REM-сне]
    O --> P[Снижение активности лобных долей]
    N --> Q[Ослабление логического мышления]
    I --> R["Дофамин (ДА)"]
    R --> S[Участие в эмоциональной окраске сновидений]

    A --> T[Гипоталамические нейропептиды]
    T --> U[Орексины]
    U --> V[Снижение уровня в REM-сне]
    V --> W[Угнетение бодрствования]
    U --> X[Возникновение сновидений]
    T --> Y["Меланин-концентрирующий гормон (МКГ)"]
    Y --> Z[Повышение уровня в REM-сне]
    Z --> AA[Эмоциональные аспекты сновидений]

    A --> AB[Влияние нейромедиаторов]
    AB --> AC[Нарушения баланса]
    AC --> AD[Изменение структуры и содержания сновидений]
    AB --> AE[Фармакологическая коррекция]
    AE --> AF[Холинергические агонисты]
    AF --> AG[Увеличение продолжительности REM-сна]
    AE --> AH[Антидепрессанты]
...
```mermaid
graph TD
    A[Эмерджентная интеграция информации в сновидениях] --> B[Количественная оценка Φₑ во время сна]
    B --> C[Формула Φₑ]
    C --> D[Вес синаптических связей w_i]
    C --> E["Интеграция информации I(x,t)"]
    C --> F["Рекуррентная активность R(x,t)"]
    C --> G["Пространственное интегрирование ∫dx"]

    A --> H[Динамика Φₑ в фазах сна]
    H --> I["Медленноволновый сон (NREM)"]
    I --> J[Стадия N1]
    J --> K[Умеренное снижение Φₑ]
    J --> L[Фрагментарные сновидения]
    I --> M[Стадия N2]
    M --> N[Минимальные значения Φₑ]
    M --> O[Редкие, менее связные сновидения]
    I --> P[Стадии N3-N4]
    P --> Q[Минимальное значение Φₑ]
    P --> R[Простые, бессвязные сновидения]

    H --> S["Быстрый сон (REM)"]
    S --> T[Значительное увеличение Φₑ]
    T --> U[Рекуррентные взаимодействия в коре]
    T --> V[Яркие, сюжетно-связные сновидения]

    A --> W[Связь Φₑ с характеристиками сновидений]
    W --> X[Яркость сновидений]
    X --> Y[Высокое Φₑ в REM-фазе]
    Y --> Z[Детализированные и насыщенные сновидения]

    W --> AA[Связность сновидений]
    AA --> AB[Высокое Φₑ]
    AB --> AC[Интеграция памяти и восприятия]
    AA --> AD[Низкое Φₑ]
    AD --> AE[Фрагментарные сновидения]

    W --> AF[Осознанность сновидений]
    AF --> AG[Высокое Φₑ]
    AG --> AH[Осознанные сновидения]
    AF --> AI[Низкое Φₑ]
    AI --> AJ[Пассивные переживания]

    W --> AK[Эмоциональная насыщенность]
    AK --> AL[Высокое Φₑ в REM]
    AL --> AM[Яркие, эмоционально насыщенные сновидения]
    AK --> AN[Низкое Φₑ в NREM]
...
graph TD
    ...
    B --> C[Рекуррентные контуры в мозге]
    C --> D[Таламо-кортикальные петли]
    C --> E[Кортико-кортикальные связи]
    C --> F[Гиппокампально-неокортикальные взаимодействия]
    
    B --> G[Механизмы рекуррентной активации]
    G --> H[Реактивация памятных следов]
    G --> I[Генерация внутренних предсказаний]
    G --> J[Интеграция разрозненной информации]
    G --> K[Поддержание активности нейронных ансамблей]
    
    B --> L[Нарушения рекуррентности]
    L --> M[Снижение рекуррентности]
    M --> N[Фрагментарные, бессвязные сновидения]
    L --> O[Избыточная рекуррентность]
    O --> P[Сверхинтегрированные, причудливые сновидения]
...
graph TD
    ...
    B --> C[Рекуррентные взаимодействия между ассоциативными областями коры]
    B --> D[Гиппокампально-неокортикальные петли]

    A --> E[Эмоциональная окраска сновидений]
    E --> F[Рекуррентные контуры с лимбической системой]
    E --> G[Модуляция нейромедиаторными системами]

    A --> H[Осознанность сновидений]
    H --> I[Рекуррентные связи в префронтальной коре]
    H --> J[Взаимодействие с теменными и париетальными областями]

    A --> K[Влияние нарушений рекуррентности]
    K --> L[Снижение рекуррентности]
    L --> M[Фрагментарные, бессвязные сновидения]
    K --> N[Избыточная рекуррентность]
    N --> O[Сверхинтегрированные, причудливые сновидения]
...
graph TD
    ...
    B --> C[Фрагментарные и бессвязные сновидения]
    B --> D[Ослабление эмоциональной окраски]
    B --> E[Нарушение консолидации воспоминаний]

    A --> F[Избыточная рекуррентность]
    F --> G[Сверхинтегрированные, причудливые сновидения]
    F --> H[Нарушение реальности в сновидениях]

    A --> I[Десинхронизация рекуррентных взаимодействий]
...
```mermaid
graph TD
    A[Предиктивное кодирование и сновидения] --> B[Формирование предсказаний во время сна]
    B --> C[Иерархическая организация предсказаний]
    B --> D[Роль рекуррентных связей]
    B --> E[Участие нейромедиаторных систем]
    B --> F[Роль эмоциональных систем]

    A --> G[Влияние предсказаний на содержание сновидений]
    G --> H[Реактивация воспоминаний]
    G --> I[Генерация фантазийных сценариев]

    A --> J[Влияние на структуру сновидений]
    J --> K[Связные сюжетные линии]
    J --> L[Фрагментарные и хаотичные сновидения]

    A --> M[Экспериментальные доказательства]
    M --> N[Активация областей, связанных с предсказаниями]
...
```mermaid
graph TD
    A[Ошибки предсказания и их влияние на сновидения] --> B[Ошибки предсказания во время сна]
    B --> C[Определение ошибки предсказания]
    B --> D[Источники ошибок предсказания]
    D --> E[Рассогласование внутренних моделей и фантастических элементов]
    D --> F[Нарушение сенсорной обратной связи]
    D --> G[Активация нейронных ансамблей, не связанных с текущим контекстом]
    B --> H[Передача ошибок предсказания в иерархии мозга]
    H --> I[Восходящие пути от сенсорных областей к ассоциативным регионам]
    H --> J[Обновление внутренних моделей]

    A --> K[Влияние ошибок предсказания на сновидения]
    K --> L[Яркость и насыщенность сновидений]
    K --> M[Связность и логическая последовательность]
    K --> N[Фрагментарность и хаотичность]
...
graph TD
    ...
    B --> C[Активность в REM-фазе]
    B --> D[Префронтальная и теменная кора]
    B --> E[Использование знаний и прошлого опыта]

    A --> F[Ошибки предсказания и обновление моделей]
    F --> G[Передача ошибок в иерархии мозга]
    F --> H[Инициирование обновления моделей]

    A --> I[Механизмы обновления моделей]
    I --> J[Активация сигнальных путей]
    I --> K[Синаптическая пластичность]
    I --> L[Изменения в экспрессии генов]
    I --> M[Модификация синаптических связей]

    A --> N["Роль быстрого сна (REM)"]
    N --> O[Высокая активность ассоциативных областей]
    N --> P[Снижение активности норадреналина]
    N --> Q[Эффективное обновление репрезентаций]

    A --> R[Клиническое значение]
    R --> S[Связь с психическими расстройствами]
...
```mermaid
graph TD
    A[Сновидения при психических расстройствах] --> B[Шизофрения]
    A --> C[Расстройства настроения]
    A --> D[ПТСР]
    A --> E[Расстройства сна]

    B --> F[Характеристики: яркие, бредоподобные сновидения]
    B --> G[Нейробиологические механизмы: гиперактивность рекуррентных контуров]
    B --> H[Связь с ЭИРО: повышение Φₑ из-за избыточной рекуррентности]

    C --> I[Депрессия]
    C --> J[Биполярное расстройство]
    I --> K[Негативный эмоциональный фон сновидений]
    I --> L[Связь с низкой активностью моноаминергических систем]
    J --> M[Гиперактивные сновидения в маниакальные фазы]
    J --> N[Мрачные сновидения в депрессивные фазы]
    C --> O[Связь с ЭИРО: нарушения баланса нейромедиаторов и Φₑ]

    D --> P[Характеристики: повторяющиеся, травматические кошмары]
    D --> Q[Нейробиология: гиперактивность миндалины, нарушение стрессовых систем]
    D --> R[Связь с ЭИРО: повышенная рекуррентность в лимбической системе]

    E --> S[Нарколепсия]
    E --> T[Апноэ сна]
    S --> U[Реалистичные, яркие сновидения]
    S --> V[Связь с нарушением цикла сон-бодрствование]
    T --> W[Фрагментарные сновидения]
    T --> X[Связь с гипоксией и снижением синхронизации процессов]
    E --> Y[Связь с ЭИРО: снижение или десинхронизация Φₑ]

    A --> Z[Изучение характеристик сновидений]
...
```mermaid
graph TD
    A[Нарушения сна и их влияние на сновидения] --> B[Влияние нарушений сна]
    A --> C[Механизмы влияния]
    A --> D[Клиническое значение]

    B --> E[Инсомния]
    B --> F[Апноэ сна]
    B --> G[Нарколепсия]
    B --> H[Расстройства циркадных ритмов]
    B --> I[Депрессия]
    B --> J[Тревожные расстройства]

    E --> K[Сокращение длительности и фрагментация сна]
    E --> L[Снижение частоты и яркости сновидений]
    E --> M[Тревожные и негативные сновидения]

    F --> N[Прерывистый, неглубокий сон]
    F --> O[Сокращение REM-сна]
    F --> P[Фрагментарные сновидения]

    G --> Q[Внезапные эпизоды сна днем]
    G --> R[Вторжение REM-сна в бодрствование]
    G --> S[Яркие, реалистичные сновидения]

    H --> T[Нарушение синхронизации фаз сна и бодрствования]
    H --> U[Изменение структуры сна]
    H --> V[Десинхронизация ритмов сновидений]

    I --> W[Увеличение длительности REM-сна]
    I --> X[Повышение эмоциональной насыщенности сновидений]
    I --> Y[Негативные, пессимистичные темы]

    J --> Z[Увеличение частоты кошмарных сновидений]
    J --> AA[Высокая эмоциональная интенсивность сновидений]
    J --> AB[Сохранение травматических воспоминаний]

    C --> AC[Изменения в рекуррентной активности]
    C --> AD[Дисбаланс нейромедиаторных систем]
    C --> AE[Нарушения циркадных ритмов]

    AC --> AF[Десинхронизация таламо-кортикальных и кортико-кортикальных петель]
    AC --> AG[Влияние на интеграцию информации и целостность сновидений]

    AD --> AH[Изменения в активности холинергической и моноаминергической систем]
    AD --> AI[Влияние на эмоциональную окраску и регуляцию сна]
    AD --> AJ[Отражение в характеристиках сновидений]

    AE --> AK[Рассогласование биологических ритмов и внешних сигналов]
    AE --> AL[Изменение структуры и содержания сновидений]

    D --> AM[Диагностика нарушений сна по характеристикам сновидений]
...
```mermaid
graph TD
    A[Терапевтический потенциал изучения сновидений] --> B[Диагностический потенциал]
    A --> C[Терапевтические возможности]

    B --> D[Выявление нарушений в работе мозга]
    B --> E[Ранняя диагностика]
    B --> F[Оценка эффективности терапии]

    D --> G[Анализ яркости, связности и эмоциональной окраски сновидений]
    D --> H[Выявление нарушений при психических и неврологических заболеваниях]

    E --> I[Изменения в сновидениях до проявления симптомов]
    E --> J[Раннее выявление шизофрении и биполярного расстройства]

    F --> K[Динамика характеристик сновидений как индикатор состояния]
    F --> L[Отражение изменений при терапии]

    C --> M[Использование сновидений в психотерапии]
    C --> N[Модификация сновидений]
    C --> O[Фармакологическое воздействие]

    M --> P[Анализ содержания и структуры сновидений]
    M --> Q[Помощь в понимании бессознательного]
    M --> R[Разрешение внутриличностных конфликтов]

    N --> S["Осознанные сновидения (lucid dreaming)"]
    N --> T[Imagery rehearsal therapy]
    N --> U[Преодоление травматических воспоминаний]

    O --> V[Влияние лекарств на нейромедиаторные системы]
    O --> W[Антидепрессанты для снижения яркости сновидений]
...
```mermaid
graph TD
    A[Математическое моделирование сновидений] --> B["Модели рекуррентных нейронных сетей (RNN)"]
    ...
    B --> B2[LSTM]
    B --> B3[GRU]
    B1 --> B11[Рекуррентность и интеграция информации]
    B2 --> B21[Долговременная память и реактивация воспоминаний]
    B3 --> B31[Упрощенные механизмы памяти]
    B11 --> B12[Формирование сновидений через циклические связи]
    B21 --> B22[Эффективное моделирование долгосрочных зависимостей]
    B31 --> B32[Уменьшенная вычислительная сложность]
    
    C --> C1[Формирование предсказаний]
    C --> C2[Ошибки предсказания]
    C --> C3[Обновление внутренних моделей]
    C1 --> C11[Генерация сенсорных событий во время сна]
    C2 --> C21[Рассогласование с фактическими элементами сновидений]
    C3 --> C31[Минимизация ошибок предсказания]
    
    D --> D1[Моделирование RNN]
    D --> D2[Байесовские модели предиктивного кодирования]
    D --> D3[Нейровизуализация]
    D --> D4[Электрофизиология]
    D --> D5[Оптогенетика]
    D --> D6[Фармакология]
    D --> D7[Клинические данные]
    D1 --> D11[Динамика активности нейронных ансамблей]
    D2 --> D21[Обновление параметров моделей]
    D3 --> D31[Валидация пространственно-временной динамики]
    D4 --> D41[Калибровка на микроуровне]
    D5 --> D51[Проверка причинно-следственных гипотез]
...
В данной диссертационной работе были рассмотрены механизмы сновидений через призму теории ЭИРО. Основные выводы исследования:
...
Данная диссертация открывает широкие возможности для дальнейшего изучения природы сновидений через призму теории ЭИРО. Некоторые ключевые направления перспективных исследований включают:
