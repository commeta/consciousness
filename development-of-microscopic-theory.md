...
```mermaid
graph TD
    A[Микроскопическая теория интеграции квантовой информации] --> B[Формализация рекуррентного пространства-времени]
    A --> C[Математические методы: теория категорий и топология]
    B --> D[Геометрические и топологические свойства]
    C --> E[Связь с квантовой гравитацией]
    D --> F[Модификация уравнений Эйнштейна]
    E --> G[Голографический принцип и энтропийная гравитация]
    F --> H[Наблюдаемые эффекты: крупномасштабная структура Вселенной]
    H --> I[Космологические наблюдения: КМФ и линзирование]
    G --> J[Унификация теории гравитации и квантовой механики]
    I --> K[Экспериментальные тесты и предсказания]
    ...
    subgraph "Теоретические разработки"
        D
        E
        F
        G
    ...
    subgraph "Космологические последствия"
        H
        I
        J
        K
