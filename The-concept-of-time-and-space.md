...
```mermaid
graph TD
    A[Концепция времени и пространства] --> D[ЭИРО framework]
    A --> E[Концепция времени и пространства через призму ЭИРО]
    A --> F[Новая модель Вселенной]
    
    D --> O[Основы теории ЭИРО]
    D --> P[Применение в нейронных системах]

    O --> Q[Сложные системы и интеграция информации]
    O --> R[Эмергентная интегрированная информация Φₑ]

    P --> S[Динамика нейронных систем]
    P --> T[Байесовское обновление вероятностей]

    E --> U[Интеграция квантовой информации]
    E --> V[Влияние информационных параметров на метрику]

    U --> W[Плотность интегрированной квантовой информации ρ_IQI]
    
    V --> X[Модификация уравнений Эйнштейна]

    F --> Y[Дискретность пространства-времени]
    F --> Z[Модифицированные уравнения Эйнштейна]

    Y --> AA[Сетка узлов и квантовая информация]
    
    Z --> AB[Космологические следствия]
```
