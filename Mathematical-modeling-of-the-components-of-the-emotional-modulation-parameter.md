...
Функция сигмоида `sigmoid(x) = 1 / (1 + e^(-x))` обеспечивает ограничение значений A(t) в диапазоне от 0 до 1, что соответствует шкале от низкого до высокого возбуждения.
