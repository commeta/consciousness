...
- $\mathbf{x}(t)$ — состояние сети в момент времени $t$.

- $\mathbf{u}(t)$ — внешние входные сигналы.
...
- Усиление определенных нейронных путей:
  ...
  - Математически: Если $I_{\text{integration}}^{\text{relevant}}(t)$ — интеграция в релевантных сетях, то во время гипноза:
   ...
   $$I_{\text{integration}}^{\text{hypnosis}}(t) = I_{\text{integration}}^{\text{relevant}}(t) + \Delta I_{\text{amplification}}(t),$$

   где $\Delta I_{\text{amplification}}(t)$ — дополнительная интеграция, вызванная гипнозом.
...
- Фокусировка на внутренних состояниях:
  ...
  - Математически: Увеличение $R_{\text{recurrence}}$ для внутренних связей:

  $$R_{\text{recurrence}}^{\text{hypnosis}}(t) = R_{\text{recurrence}}^{\text{internal}}(t) + \Delta R_{\text{amplification}}(t).$$
...
- Ослабление внешних входов:
  ...
  - Математически: Снижение $R_{\text{recurrence}}$ для внешних входов:

  $$R_{\text{recurrence}}^{\text{hypnosis}}(t) = R_{\text{recurrence}}^{\text{external}}(t) - \Delta R_{\text{suppression}}(t).$$
