...
ЭИРО утверждает, что сложные системы и феномены, включая сознание и вселенную, возникают из процессов интеграции информации через рекуррентные взаимодействия. Ключевым параметром является эмергентная интегрированная информация (Φ_\varepsilon), определяемая как:

Φ_\varepsilon = ∫₀^(t₁) I_(интеграции)(t) ⋅ R_(рекуррентности)(t)dt,
...
▎Интеграция в пространственно-временной скале
...
▎Интегрированная информация в мозге
