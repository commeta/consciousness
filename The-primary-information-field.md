...
graph TD
    ...
    A --> B[Определение концепции]
    A --> C[Роль в теории ЭИРО]
    B --> D[Фундаментальная сущность информации]
    B --> E[Связь с физическими процессами]
    C --> F[Интеграция информации в эмерджентных системах]
    C --> G[Рекуррентные процессы передачи информации]
    D --> H[Основы квантовой информации]
    D --> I[Математическое описание]
    E --> J[Информационные потоки в физике]
    E --> K[Квантовые и классические взаимодействия]
    F --> L[Формирование сложных структур]
    F --> M[Эволюция информационного поля]
    G --> N[Роль в масштабах Вселенной]
    G --> O[Влияние на развитие галактик и звезд]
    A --> P[Приложения концепции]
    P --> Q[Космология]
    P --> R[Квантовая физика]
    P --> S[Информационные технологии]
    Q --> T[Объяснение крупномасштабной структуры]
    R --> U[Квантовые вычисления]
    S --> V[Создание новых подходов к обработке данных]
```
