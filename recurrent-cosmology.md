...
graph TD
    ...
    A --> B[Основные элементы теории]
    A --> C[Связь с квантовыми процессами]
    A --> D[Роль тёмной энергии и материи]
    A --> E[Интеграция с теорией ЭИРО]

    B --> F[Рекуррентные циклы Вселенной]
    B --> G[Моделирование эволюции пространства-времени]
    B --> H[Топологические структуры]

    C --> I[Квантовые флуктуации]
    C --> J[Декогеренция в масштабах Вселенной]
    C --> K[Информационные процессы в квантовых системах]

    D --> L[Энергетическая плотность Вселенной]
    D --> M[Моделирование распределения тёмной материи]
    D --> N[Роль тёмной энергии в расширении Вселенной]

    E --> O[Эмерджентность в космических масштабах]
    E --> P[Рекуррентные процессы в гравитации]
    E --> Q[Интеграция информации на крупномасштабных структурах]

    F --> R[Переход между циклами]
    F --> S[Инфляционные процессы]
    G --> T[Кривизна и топология пространства-времени]
    G --> U[Влияние на формирование галактик]
    H --> V[Топологические дефекты и их свойства]

    I --> W[Влияние на крупномасштабную структуру]
    J --> X[Сохранение когерентности]
    K --> Y[Передача информации через квантовые состояния]

    L --> Z[Аномалии в плотности энергии]
    M --> AA[Гравитационное линзирование]
    N --> AB[Ускорение расширения Вселенной]

    O --> AC[Образование галактик и звёзд]
    P --> AD[Рекуррентные гравитационные волны]
    Q --> AE[Предсказания для будущих наблюдений]
```
