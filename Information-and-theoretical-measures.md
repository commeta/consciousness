...
```mermaid
graph TD
    A[Информационно-теоретические меры]
    A --> B[Применение в модели Вселенной]
    A --> C[Меры информации в физике]
    B --> D[Эмерджентная интеграция информации]
    B --> E[Рекуррентные процессы в системах]
    C --> F[Энтропия и её значение]
    C --> G[Информация Шеннона]
    C --> H[Меры сложности]
    D --> I[Интеграция данных в космологии]
    D --> J[Эволюция Вселенной через меры информации]
    E --> K[Анализ рекуррентных взаимодействий]
    E --> L[Устойчивость систем и информационный обмен]
    F --> M[Связь энтропии и порядка]
    G --> N[Квантовая информация]
    G --> O[Анизотропии космического микроволнового фона]
    H --> P[Меры структурной сложности]
    H --> Q[Прогнозы поведения сложных систем]
    A --> R[Приложения информационных мер]
    R --> S[Космология]
    R --> T[Квантовая физика]
    R --> U[Теория информации]
    S --> V[Описание крупномасштабной структуры Вселенной]
    T --> W[Квантовые системы и их энтропия]
    U --> X[Новые подходы к измерению информации]
```
