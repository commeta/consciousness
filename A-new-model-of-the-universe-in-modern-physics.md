...
graph TD
    ...
    A --> B[Эмерджентная интеграция информации Φₑ]
    A --> C[Рекуррентные процессы]
    B --> D[Математическое описание]
    D --> E[Уравнение состояния: d𝐱/dt]
    D --> F[Интеграция информации: I интеграции ⋅ R рекуррентности]
    C --> G[Примеры рекуррентных взаимодействий]
    G --> H[Квантовые флуктуации]
    G --> I[Гравитационная рекуррентность]
    G --> J[Информационные потоки в системах]
    F --> K[Анализ структуры Вселенной]
    F --> L[Прогноз эволюции систем]
    I --> M[Формирование галактик]
    I --> N[Крупномасштабная структура Вселенной]
    H --> O[Флуктуации плотности материи]
    H --> P[Анизотропии микроволнового фона]
    A --> Q[Приложения теории]
    Q --> R[Космология]
    Q --> S[Физика элементарных частиц]
    Q --> T[Квантовая химия]
    Q --> U[Математика]
    R --> V[Решение космологических парадоксов]
    S --> W[Построение новых моделей взаимодействия частиц]
    T --> X[Объяснение химических связей]
    U --> Y[Математические структуры для анализа систем]
```
